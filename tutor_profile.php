...
<div class="form-group">
						...
						<button type="submit" name="edit" class="btn btn-two">Update</button><p><br/></p>
	...
	<?php }?>
		...
		<?php 
					$sql1="select subject_id,subject_name,ce.expertize from subject s,courses_experience ce where s.subject_id=ce.course_id and ce.tutor_id=1 order by subject_name";
					$result1=mysql_query($sql1);
$h=0;
while($proarray1=mysql_fetch_row($result1)){
