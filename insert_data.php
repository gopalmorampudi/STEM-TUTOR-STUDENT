...
$query="insert into student(student_name,emailid,password,major) values('$student_name','$emailid','$password','$major')";
...
//Update student...
	...
	if($major2=="")
		...
		$major.=$major2;
	$sql="update student set student_name='$student_name',major='$major' where student_id='$student_id'";
	$res=mysql_query($sql);
	if($res){
		//echo 'success';
