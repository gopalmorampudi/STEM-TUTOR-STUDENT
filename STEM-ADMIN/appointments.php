...
$ftm=$res['from_min'];
$ttm=$res['to_min'];
echo $ftime=$fth.":".$ftm." To ".$ftime=$tth.":".$ttm;
?></td>
<td>
...
<input type="hidden" name="aptime" value="<?=$ftime?>">
