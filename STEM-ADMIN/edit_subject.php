...
<input type="text" class="form-control" name="subject_id" value="<?=$proarr['course_id'];?>"readonly required/>
<label>Course Name</label>
<input type="text" class="form-control" name="subject_name" value="<?=$proarr['subject_name'];?>" required/>
<label>Department Name</label>
<input type="text" class="form-control" name="subject_name" value="<?=$proarr['dept_id'];?>" required/>
<?php
}
}
?>
