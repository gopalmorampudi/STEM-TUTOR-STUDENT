...
<li><a href="view_dept.php"></i>View Departments </a></li>
<li><a href="add_department.php"></i>Add Department</a></li>
</ul>
</li>
<li class="treeview">
 <a href="#">
...
<span>Student Become Tutor</span>
</a>
</li>
<li class="treeview">
...
<td><?=$rs['emailid']?><input type="hidden" name="emailid" value="<?=$rs['emailid']?>"></td>
<td><?=$rs['subject_name']?><input type="hidden" name="subject_name" value="<?=$rs['subject_name']?>"></td>
<td><?=$rs['tutor_name']?><input type="hidden" name="tutor_name" value="<?=$rs['tutor_name']?>"></td>
<td><?=$rs['description']?><input type="hidden" name="description" value="<?=$rs['description']?>"></td>
<td>
